package app.hypershell.ui.theme
...
import app.hypershell.ui.theme.m3color.dynamicColorScheme
...
fun HyperShellTheme(
    ...
    CompositionLocalProvider(
        ...
        if (useMiuix) {
            ...
            HyperShellMaterialExpressiveTheme(
                darkTheme = isDark,
...
@Composable
fun HyperShellMaterialExpressiveTheme(
